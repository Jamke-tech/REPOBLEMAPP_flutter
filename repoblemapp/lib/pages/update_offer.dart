...
class _UpdateOfferState extends State<UpdateOffer> {
  ...
  final placeInputController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    priceInputController.text = infoOfOffer["price"];
    nameInputController.text = infoOfOffer["name"];
    surnameInputController.text = infoOfOffer["surname"];
    phoneInputController.text = infoOfOffer["phone"];
